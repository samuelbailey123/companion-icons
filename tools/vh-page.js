		...
		style: {
			layers: [
				...
				},
				{
					...
					enabled: v(true), opacity: v(100), x: v(4), y: v(4), width: v(92), height: v(34), rotation: v(0),
					text: v(`$(videohub:output_${outputNumber})`),
					color: v(0xa78bfa), halign: v('center'), valign: v('center'),
					fontsize: v(26), fontsizeAllowShrink: v(true), font: v('companion-sans'), outlineColor: v(0xff000000),
				},
				{
					id: 'text1', name: 'Source', usage: 'auto', type: 'text',
					enabled: v(true), opacity: v(100), x: v(4), y: v(40), width: v(92), height: v(54), rotation: v(0),
					text: v(`$(videohub:output_${outputNumber}_input)`),
					color: v(0xffffff), halign: v('center'), valign: v('center'),
					fontsize: v(44), fontsizeAllowShrink: v(true), font: v('companion-sans'), outlineColor: v(0xff000000),
				},
			],
		},
